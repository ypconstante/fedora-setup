...
my:step-begin "hide desktop icons"
...
my:step-begin "modify menu"
my:wait-file $menu_config_file
...
my:link-file "$ASSETS_DIR/desktop_de_cinnamon--menu.menu" "$XDG_CONFIG_HOME/menus/cinnamon-applications.menu"
